...
activitySelect.addEventListener(
    ...
    function () {
        ...
        if (this.value === "machining") {
            ...
            dynamicFields.innerHTML = `
                ...
                <div class="form-group">
                    ...
                    <label for="machineDescription">
                        توضیحات تکمیلی دستگاه
                    </label>

                    <textarea
                        id="machineDescription"
                        name="machineDescription"
                        placeholder="توضیحات بیشتر درباره دستگاه..."
                    ></textarea>
        ...
        else if (this.value === "welding") {

            dynamicFields.innerHTML = `

                <h3 class="dynamic-title">
                    اطلاعات خدمات جوشکاری
                </h3>
        ...
        else if (this.value === "casting") {

            dynamicFields.innerHTML = `

                <h3 class="dynamic-title">
                    اطلاعات خدمات ریخته‌گری
                </h3>
            ...
            dynamicFields.innerHTML = `
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        placeholder="نوع خدمات خود را توضیح دهید..."
                    ></textarea>
